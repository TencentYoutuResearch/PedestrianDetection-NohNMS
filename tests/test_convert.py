...
detectron_models = torch.load(
    "/data1/penghaozhou/workspace/Experiments/detectron2/Crowdhuman/faster_rcnn_R_50_FPN_baseline_iou0.5_align_crowddet_without_bn/model_0000799.pth"
)["model"]
...
torch.save(
    {"model": convert_model},
    "/data1/penghaozhou/workspace/PretrainModels/convert_crowddet_pretrain_model.pth",
)
